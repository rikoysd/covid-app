                      ...
                      if (changePatientsFlag === true) {
                        return (
                          <tbody>
                            ...
                            <STr2>
                              <SBorder>
                                対策病床数 {Number(allBedNum).toLocaleString()}
                                床
                              </SBorder>
                              <SBorder>
                                PCR検査陽性者数{" "}
                            ...
                            <STr2>
                              ...
                              >
                                臨床工学技士{" "}
                                {Number(ventilator[0].ce).toLocaleString()}人 /
                                人工呼吸器{" "}
                                {(
                                ...
                                台 / ECMO{" "}
                                {Number(ventilator[0].ecmo).toLocaleString()}台
                                <br />
                                2020年2月回答 出典
                                <a
                                  style={{ color: "#696969" }}
                        ...
                        return (
                          <tbody>
                            ...
                            <STr>
                              <SBorder>
                                {Number(country.nexits).toLocaleString()}
                                <SUnit>人</SUnit>
                              </SBorder>
                              <SBorder>
                                {Number(country.ndeaths).toLocaleString()}
                                <SUnit>人</SUnit>
                              </SBorder>
                            </STr>
                            <STr2>
                              ...
                              <SBorder>
                                PCR検査陽性者数{" "}
                                {Number(country.npatients).toLocaleString()}人
                              </SBorder>
                            </STr2>
                            <STr2>
                              <SBorder
